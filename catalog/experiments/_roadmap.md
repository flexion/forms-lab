...
| [#73 Maya's extractions use temperature + hybrid prompt](https://github.com/flexion/forms-lab/issues/73) | in-progress | `extraction/sonnet-temperature-zero`, `extraction/sonnet-hybrid-v1` | `/catalog/experiments/pdf-field-extraction/sonnet-temperature-zero.md`, `/catalog/experiments/pdf-field-extraction/sonnet-hybrid-v1.md` |
