...
- Name: src/design-system/components/flex-header/conformance.test.ts >> flex-header user menu >> outside click closes the menu
- Location: src/design-system/components/flex-header/conformance.test.ts:245:3
