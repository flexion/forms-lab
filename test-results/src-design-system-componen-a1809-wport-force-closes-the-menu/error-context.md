...
- Name: src/design-system/components/flex-header/conformance.test.ts >> flex-header user menu >> crossing to mobile viewport force-closes the menu
- Location: src/design-system/components/flex-header/conformance.test.ts:260:3
