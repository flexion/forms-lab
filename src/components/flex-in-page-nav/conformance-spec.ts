  ...
  fixtures: [
    {
      ...
      uswds: `<nav class="usa-in-page-nav__nav" aria-label="On this page">
    <h4 class="usa-in-page-nav__heading">On this page</h4>
    <ul class="usa-in-page-nav__list">
      <li class="usa-in-page-nav__list__item">
        <a href="#section-1" class="usa-in-page-nav__link" data-testid="target">Section 1</a>
      </li>
      <li class="usa-in-page-nav__list__item">
    ...
    <nav class="flex-in-page-nav__nav" aria-label="On this page">
      ...
      <ul class="flex-in-page-nav__list">
        <li class="flex-in-page-nav__item">
          <a href="#section-1" class="flex-in-page-nav__link" data-testid="target">Section 1</a>
        </li>
        <li class="flex-in-page-nav__item">
          <a href="#section-2" class="flex-in-page-nav__link">Section 2</a>
        </li>
      </ul>
    </nav>
  </flex-in-page-nav>`,
