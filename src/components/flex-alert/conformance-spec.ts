...
export const spec: ConformanceSpec = {
  ...
  fixtures: [
    {
      name: 'info alert background and border match USWDS',
      uswds: `<div class="usa-alert usa-alert--info" role="alert" data-testid="target">
      ...
      flex: `<div class="flex-alert" data-variant="info" role="alert" data-testid="target">
    ...
    {
      name: 'error alert background and border match USWDS',
      uswds: `<div class="usa-alert usa-alert--error" role="alert" data-testid="target">
        <div class="usa-alert__body">
          <h4 class="usa-alert__heading">Error status</h4>
          <p class="usa-alert__text">Lorem ipsum dolor sit amet, <a href="javascript:void(0);" class="usa-link">consectetur adipiscing</a> elit, sed do eiusmod.</p>
        </div>
      </div>`,
      flex: `<div class="flex-alert" data-variant="error" role="alert" data-testid="target">
        <h4 class="flex-alert__heading">Error status</h4>
        <p class="flex-alert__text">Lorem ipsum dolor sit amet, <a href="javascript:void(0);">consectetur adipiscing</a> elit, sed do eiusmod.</p>
      </div>`,
    },
    {
      name: 'success alert background and border match USWDS',
      uswds: `<div class="usa-alert usa-alert--success" role="alert" data-testid="target">
        <div class="usa-alert__body">
          <h4 class="usa-alert__heading">Success status</h4>
          <p class="usa-alert__text">Lorem ipsum dolor sit amet, <a href="javascript:void(0);" class="usa-link">consectetur adipiscing</a> elit, sed do eiusmod.</p>
        </div>
      </div>`,
      flex: `<div class="flex-alert" data-variant="success" role="alert" data-testid="target">
        <h4 class="flex-alert__heading">Success status</h4>
        <p class="flex-alert__text">Lorem ipsum dolor sit amet, <a href="javascript:void(0);">consectetur adipiscing</a> elit, sed do eiusmod.</p>
      </div>`,
    },
    {
      name: 'warning alert background and border match USWDS',
      uswds: `<div class="usa-alert usa-alert--warning" role="alert" data-testid="target">
        <div class="usa-alert__body">
          <h4 class="usa-alert__heading">Warning status</h4>
          <p class="usa-alert__text">Lorem ipsum dolor sit amet, <a href="javascript:void(0);" class="usa-link">consectetur adipiscing</a> elit, sed do eiusmod.</p>
        </div>
      </div>`,
      flex: `<div class="flex-alert" data-variant="warning" role="alert" data-testid="target">
